...
class ResNet(nn.Module):
    def __init__(self,modelName, block, num_blocks,num_classes,dim_in,pretrained, in_channel=3, zero_init_residual=False):
...
def get_resnet_contrastive_big_pretrained(name='resnet18', num_classes=10, pretrained=False):
